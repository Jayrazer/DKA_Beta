...
-- Appearance
--
SWEP.ViewModel				= "models/weapons/dka/c_dka_smg_apc9k.mdl"
SWEP.WorldModel				= "models/weapons/dka/c_dka_smg_apc9k.mdl"
SWEP.VMWMClone				= { Pos = Vector(), Ang = Angle(), Size = Vector() }
SWEP.ViewModelFOV			= 60

SWEP.ActivePose = {
	Pos = Vector( 0.0, -1, -0.75 ),
	Ang = Angle( 3, 0, 3 )
}
SWEP.CrouchPose = {
...
local p1 = ")weapons/mp5/"
local tail = ")/arccw_uc/common/556x45/"
SWEP.Sound_Blast			= {
	{ s = p1.."mp5a_fire_01.wav" },
	{ s = p1.."mp5a_fire_02.wav" },
	{ s = p1.."mp5a_fire_03.wav" }
}
--SWEP.Sound_Mech				= {
	--{ s = p1.."mech-01.ogg" },
	--{ s = p1.."mech-02.ogg" },
...
-- Damage
--
SWEP.DamageNear				= 100 / 6
SWEP.RangeNear				= 50
SWEP.DamageFar				= 100 / 9
SWEP.RangeFar				= 300
SWEP.Force					= 5
SWEP.Penetration			= 2
