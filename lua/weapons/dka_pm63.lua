...
-- Appearance
--
SWEP.ViewModel				= "models/weapons/dka/c_dka_smg_pm63.mdl"
SWEP.WorldModel				= "models/weapons/dka/c_dka_smg_pm63.mdl"
...
local p1 = ")weapons/pm63/"
local tail = ")/arccw_uc/common/556x45/"
SWEP.Sound_Blast			= {
	{ s = p1.."pm63_fire_01.wav" },
	{ s = p1.."pm63_fire_02.wav" },
	{ s = p1.."pm63_fire_03.wav" }
}
--SWEP.Sound_Mech				= {
	--{ s = p1.."mech-01.ogg" },
	--{ s = p1.."mech-02.ogg" },
